...
<script src="<%=request.getContextPath()%>/media/js/jquery.js" type="text/javascript"></script>
...
<body class="login-page">
	<div class="login-form">
		<div class="login-content">
			...
			<form id="login-form" action="<%=request.getContextPath()%>/user/login" role="form" method="post" onsubmit="return false;">
