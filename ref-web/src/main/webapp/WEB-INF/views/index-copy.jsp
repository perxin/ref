...
<head>
  ...
  <script type="application/javascript" src="<%=request.getContextPath()%>/media/user/custom.js"></script>
</head>
<body>
            ...
            <div class="col">
              ...
              <div class="wrapper bg-white b-b">
                <ul class="nav nav-pills nav-sm">
                  <li class="active"><a href="javascript:void(0);" onclick="getPageHot()">热门文章</a></li>
                  <li><a href>最新文章</a></li>
