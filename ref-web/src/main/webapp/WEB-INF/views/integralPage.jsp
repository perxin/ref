...
<div class="app app-header-fixed" id="app">
    ...
    <div class="app-content navbar-collapse">
        <div class="app-content-body fade-in-up content" style="width: 80%;">
            ...
            <div class="padder">
                <% PageInfo<IntegralRecord> pageInfo = (PageInfo) request.getAttribute("page"); %>
                ...
                <table class="table table-bordered table-striped" style="margin-top: 30px;">
                    ...
                    <%
                        ...
                        List<IntegralRecord> list = pageInfo.getList();
                        for (IntegralRecord record : list) {
                    %>
                    <tr>
                        <td><% out.print(record.getDescription());%></td>
                        <td>
